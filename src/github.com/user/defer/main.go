...
func main() {
	...
	defer arquivo.Close() //manda fechar o arquivo depois que o programa fechar
	...
	defer arquivoJSON.Close() //manda fechar o arquivo depois que o programa fechar
